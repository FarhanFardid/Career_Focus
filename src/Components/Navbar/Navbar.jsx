...
const Navbar = () => {
    return (
        ...
        <div className='grid grid-cols-12 md:p-4 p-5 bg-slate-600 items-center justify-center'>
            ...
            <div className='col-span-12 md:col-span-2 border-2 bg-blue-600 text-white mx-auto md:px-3  md:py-3 rounded-lg font-semibold hover:bg-slate-700 p-2 m-2 text-sm md:text-lg'><button>Start Applying</button></div>
        </div>
